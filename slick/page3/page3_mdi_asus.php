...
$mdi02 = "SELECT manf_device, COUNT(id_device) FROM mdl GROUP BY manf_device HAVING manf_device='asus';";
$rs_mdi02 = mysqli_query($con, $mdi02);
$row = mysqli_fetch_assoc($rs_mdi02);
mysqli_data_seek($rs_mdi02, 0);
$cnt_asus        = $row["COUNT(id_device)"];	
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
  ...
  <script type="text/javascript">
    ...
    function drawChart(){
      ...
      var chart2 = new google.visualization.BarChart(document.getElementById('chart_div_core3'));
