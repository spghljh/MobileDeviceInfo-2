...
if (isset($_GET["id_cpu"]))				// $_GET["num"] : 레코드 번호
	...
	$result = mysqli_query($con, "select * from mcl where id_cpu=$id_cpu");
    $sql="select * from mcl where id_cpu=$id_cpu";
...
<div class="Module_Layout_1_1"><!--div class="Module_Layout_1_1"-->
    ...
    <div class="Module_Layout_1_1_1_view">
        <div class="Module_Layout_1_1_1_1">
            ...
            <div class="Module_Layout_1_1_1_1_1" style="height:120px;">
                    ...
                    <div class="module3_ForMainTitle" >
                                        ...
                                        <div><div class="Module_Layout_1_1_1_1_0" style="margin-right:8px; margin-top:8px; margin-left:7px;"><a style="font-size:18px;">P2</a></div></div>
                                            <div class="page1view_id_body_title_part1_ForMainTitle_Total" >
                                                    <a class = "Module_Layout_1_1_1_1_1_0" STYLE="MARGIN-RIGHT:12PX; font-size:22px; color: white !important;">프로세서 상세정보</a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0_22" STYLE="MARGIN-RIGHT:12PX; font-size:22px;">></a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0" STYLE="MARGIN-RIGHT:12PX; font-size:22px; color: white !important;" ><?=$manf_cpu?></a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0_22" STYLE="MARGIN-RIGHT:12PX; font-size:22px;">></a>
                                                    <a class = "Module_Layout_1_1_1_1_1_0" STYLE="MARGIN-RIGHT:12PX; font-size:22px; color: white !important;"><?=$name_cpu?></a>
                                            </div>
                                        ...
                                        <div class="page1view_id_body_title_ForMainTitle" style="margin-top:5px;">


                                            <div class="page1view_id_body_title_part2_ForMainTitle">
                                                <div class="page1view_id_body_title_part2_name_cpu_ForMainTitle"><a><?php echo $name_cpu?></a></div>
                                            </div>


                                            <div class="page1view_id_body_title_part4_ForMainTitle">
                                            <table>
                                                <tr><td><?php include "./page1view_id_maintitle/AddChoice_cpu.php"; ?></td></tr>
                                            </table>
                                            </div>
...
<div class="module_name2">
    ...
    <div class="page1view_id_body_content_outer_title_moduleName3">
        <a class="page1view_id_body_content_outer_title_moduleName3_text">프로세서의 기본적인 정보를 확인할 수 있습니다.</a>
...
<div class="module_spec_cpu">
        ...
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_spec/ManfGraph_id_cpu.php');?>
        </div>  

        <div class="module_spec_cpu_version2">
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_spec/ReleaseGraph_id_cpu.php');?>
        </div>

        <div class="module_spec_cpu_version2">
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_spec/CoreGraph_id_cpu.php');?>
        </div>

        <div class="module_spec_cpu_version2">
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_spec/ThreadGraph_id_cpu.php');?>
        </div>

        <div class="module_spec_cpu_version2">
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_spec/MaxghzGraph_id_cpu.php');?>
        </div>
                                    
        <div class="module_spec_cpu_version2">
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_spec/MinghzGraph_id_cpu.php');?>
        </div>
...
<div class="module_name2">
    ...
    <div class="page1view_id_body_content_outer_title_moduleName3">
    <a class="page1view_id_body_content_outer_title_moduleName3_text">해당 프로세서를 탑재한 제조사와 디바이스 수를 보여줍니다.</a>
    </div>
...
<?php include ($_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/BrandGraph/BrandGraph_MDL_MANF_id_cpu.php');?>
...
<div class="module_name2">
    ...
    <div class="page1view_id_body_content_outer_title_moduleName3">
    <a class="page1view_id_body_content_outer_title_moduleName3_text">해당 프로세서가 탑재된 디바이스를 살펴보세요.</a>
    </div>
...
<?php include $_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/page1view_id_body_CpuSpecToDevice.php';?>
