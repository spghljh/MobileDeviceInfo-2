...
<div class="line_spec">   
      ...
      <div class="chart_div_image1">
              ...
              <div class="chart_div_image4_brand " style="margin-right:5px;">
                  <a href="./page1/page1_SearchModule_ResultPage.php?catgo=manf_cpu&search=<?=$manf_cpu?>" ><?php include $_SERVER['DOCUMENT_ROOT'].'/resources/views/page1/percpuBrand.php'; ?></a>
                  </div>
              </div>
