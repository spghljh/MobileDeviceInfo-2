...
<?php include $_SERVER['DOCUMENT_ROOT'].'/resources/views/page3/page3_mdi_module.php';?>
</div>
...
<tr class="SearchResult_Table_Row_page1">   
    ...
    <td>
        <div class="total1_name">
            <div class="total2_name"><a href="../resources/views/page1/page1view_id.php?id_cpu=<?=$id_cpu?>"><?=$name_cpu?></a></div>
        </div>
    </td>
