...
<div class="chart_div_CpuGraph_line">
  ...
  <?php
      ...
      {
        ?>
      <img class="perBrand" src="../resources/views/page2/page2view_image/intel.png" style="margin-left : -2px;">
      ...
      {
        ?>
      <img class="perBrand" src="../resources/views/page2/page2view_image/amd.png" style="margin-left : -2px;">
      ...
      {
        ?>
      <img class="perBrand" src="../resources/views/page2/page2view_image/mediateck.png" style="margin-left : -2px;">
      ...
      {
        ?>
      <img class="perBrand" src="../resources/views/page2/page2view_image/qualcomm.png" style="margin-left : -2px;">
