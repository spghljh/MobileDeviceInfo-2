...
<<<<<<< HEAD
            <?php include $_SERVER['DOCUMENT_ROOT'].'/resources/views/modules/box/cpu/module_box-device_list.php';?>
=======
            <?php include $_SERVER['DOCUMENT_ROOT'].'/mdi2/resources/views/modules/box/cpu/module_box-device_list.php';?>
>>>>>>> 698cd26 (rebase작업을 위한 커밋)
