...
<div class="div2">
    <div class="hotdevice">
        ...
        $result = mysqli_query($con, "select * from mdl order by choice_device desc");
        $sql = "select * from mdl order by choice_device desc";
...
<li><a href="./resources/views/page2/page2view_id.php?id_device=<?=$id_device?>" style="padding-left:37px; font-size:27px;">(+<?=$choice_device?>) <?=$name_device?></a></li>
        <?php
            }
            ?>
        </ul>
