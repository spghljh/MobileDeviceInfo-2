...
<?php
    if (isset($_GET["name_device"]))				// $_GET["num"] : 레코드 번호
		...
		// DB 접속
	$sql3 = "SELECT * FROM mdl WHERE name_device='$data5_device'";	// 레코드 검색
...
<div class = "cpulist_per_user2_outer">
    ...
    <div class = "cpulist_per_user2_2">
        ...
        <div class="delete_button">
            <a class = "delete_button_css" onclick="location.href='./delete_device_FromUserDevice_data5_device.php' ">삭제</a>
        </div>
