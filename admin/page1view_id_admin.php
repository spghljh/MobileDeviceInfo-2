...
if (isset($_GET["id_cpu"]))				// $_GET["num"] : 레코드 번호
		...
		// DB 접속
	$result775 = mysqli_query($con, "select * from mcl where id_cpu=$id_cpu");
    $sql775 = "select * from mcl where id_cpu=$id_cpu";	// 레코드 검색

	$row = mysqli_fetch_assoc($result775);			// 레코드 가져오기
	$id_cpu= $row["id_cpu"];		
...
<div class="module_name2">
    ...
    <button type="save_button_admin_page1" class="save_button_admin_page1" onclick="location.href='./page1view_id_admin_modify.php?id_cpu=<?=$id_cpu?>'">
        <a href ="./page1view_id_admin_modify.php?id_cpu=<?=$id_cpu?>">
            <a>수정</a></a></button>
...
<div class="module_spec_cpu">
        ...
        <?php include ($_SERVER['DOCUMENT_ROOT'].'/page1/page1view_id_spec/NameGraph_id_cpu.php');?>
        </div>
        -->
